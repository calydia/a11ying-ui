import { jsx as t, Fragment as k, jsxs as s } from "react/jsx-runtime";
import j from "sanitize-html";
import D, { useMemo as H, useState as m, useEffect as F } from "react";
import { stringify as _ } from "qs-esm";
function re({
  children: e,
  variant: r = "primary",
  href: a,
  ...
  return a ? /* @__PURE__ */ t("a", { href: a, className: c, children: e }) : /* @__PURE__ */ t("button", { type: n, onClick: l, disabled: i, className: c, children: e });
}
function ae({ variant: e = "toc", children: r, className: a = "" }) {
...
function le({ href: e, id: r, label: a, forceVisible: l = !1 }) {
...
function L(e) {
  ...
  function a(l) {
    if (l.type === "heading") {
      const n = l.children?.map((o) => o.text || "").join("") || "", i = w(n);
      r.push({ id: i, text: n, level: l.tag });
    }
    if (l.type === "block" && l.fields?.blockType === "ContentBox") {
      const n = l.fields?.heading?.replace(" ", "-"), i = w(n ?? "") || "content-box";
      r.push({ id: i, text: l.fields?.heading ?? "", level: "h2" });
    }
...
const T = {
  ...
  heading: (e, r) => {
    const a = e.tag || "h2", l = e.children?.map((i) => i.text || "").join("") || "", n = w(l);
    return /* @__PURE__ */ t(a, { id: n, className: "font-bold mt-6 mb-2", children: r });
  },
  text: (e) => {
    let r = e.text;
    return e.format && (e.format & 1 && (r = /* @__PURE__ */ t("strong", { children: r })), e.format & 2 && (r = /* @__PURE__ */ t("em", { children: r })), e.format & 4 && (r = /* @__PURE__ */ t("s", { children: r })), e.format & 8 && (r = /* @__PURE__ */ t("u", { children: r })), e.format & 16 && (r = /* @__PURE__ */ t("code", { children: r })), e.format & 32 && (r = /* @__PURE__ */ t("sub", { children: r })), e.format & 64 && (r = /* @__PURE__ */ t("sup", { children: r }))), /* @__PURE__ */ t(k, { children: r });
  },
  ...
  block: (e, r, a) => {
    ...
    if (l === "DisclosureWidget") {
      ...
      return /* @__PURE__ */ s("details", { children: [
        ...
        /* @__PURE__ */ t("div", { className: "details-content", children: /* @__PURE__ */ t(S, { nodes: n, lang: a }) })
      ] });
    }
    if (l === "ContentBox") {
      const n = e.fields?.boxContent?.root?.children || [], i = e.fields?.heading?.replace(" ", "-") ?? "", o = w(i) || "content-box", c = e.fields?.cssClass, f = e.fields?.cssClass === "box-gradient" ? "gradient-border-light dark:gradient-border-dark" : "";
      return /* @__PURE__ */ s("div", { className: `${c} ${f}`, children: [
        /* @__PURE__ */ t("h2", { id: o, children: e.fields?.heading }),
        /* @__PURE__ */ t("div", { className: "content-box--inner-wrapper", children: /* @__PURE__ */ t(S, { nodes: n, lang: a }) })
      ] });
    }
    return l === "CodeBlock" ? e.fields?.renderField ? /* @__PURE__ */ t(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: z(e.fields?.HTMLContent) }
      }
...
function A(e, r, a) {
  const l = e.children?.map((n, i) => A(n, i, a)) || [];
  return T[e.type] ? /* @__PURE__ */ t(D.Fragment, { children: T[e.type](e, l, a) }, r) : /* @__PURE__ */ s("span", { className: "bg-red-100 text-red-700", children: [
    "[Unhandled node type: ",
    e.type,
    "]"
  ] }, r);
...
function S({ nodes: e, lang: r, withTOC: a = !1, tocLabel: l }) {
  const n = H(() => L(e), [e]), i = l ?? G(r);
  return a ? /* @__PURE__ */ t(k, { children: n.length > 0 && /* @__PURE__ */ s("div", { className: "toc-box", children: [
    /* @__PURE__ */ t("h2", { id: "toc-heading", className: "mb-2 mt-0", children: i }),
    /* @__PURE__ */ t("nav", { "aria-labelledby": "toc-heading", children: /* @__PURE__ */ t("ul", { className: "ml-4 mb-0", children: n.map((o) => /* @__PURE__ */ t("li", { children: /* @__PURE__ */ t("a", { href: `#${o.id}`, className: "text-blue-600 underline", children: o.text }) }, o.id)) }) })
  ] }) }) : /* @__PURE__ */ t(k, { children: e.map((o, c) => A(o, c, r)) });
}
async function R(e, r, a) {
  const l = a ? `locale=${a}` : "", n = `${e}/api/search?${l}&pagination=false&${r}`, i = await fetch(n);
  if (!i.ok) throw new Error(`Search request failed: ${i.status}`);
  return i.json();
}
function P(e, r) {
...
function ne({
  ...
  const [x, N] = m(""), [y, h] = m(null), [u, E] = m(), [Z, B] = m("");
  function I(d) {
    return v[d] ?? b;
  }
  const q = async (d, p) => {
  ...
  return /* @__PURE__ */ s("div", { children: [
    ...
    /* @__PURE__ */ t("div", { className: "sr-only", role: "status", children: u > 0 ? `${u} ${l}` : n }),
    /* @__PURE__ */ s("div", { className: "text-lt-gray dark:text-dk-gray pt-4 pb-2 px-4-px max-w-xl mx-auto md:py-6 md:px-8-px lg:max-w-4xl", children: [
      ...
      y && /* @__PURE__ */ t("ul", { children: y.docs.map((d, p) => {
        const C = P(d.doc.relationTo, i), g = U(d.doc.relationTo, i), W = I(d.doc.relationTo);
        return /* @__PURE__ */ s(
          "li",
          {
...
function ie({ darkLabel: e, lightLabel: r }) {
  ...
  return F(() => {
    ...
    c === "enabled" ? n() : c === "disabled" ? i() : window.matchMedia("(prefers-color-scheme: dark)").matches ? n(!1) : i(!1);
  }, []), /* @__PURE__ */ s(
    "button",
    {
      ...
      "aria-pressed": a,
      onClick: () => {
        document.documentElement.classList.contains("dark") ? i() : n();
      },
...
function se({
  ...
  const [c, f] = m(!1), b = (h, u) => n === "demo" ? `/${u}/demo/${h}/` : h === "front" ? `/${u}/` : `/${u}/${h}/`, v = b(e, "en"), x = b(r, "fi");
...
function oe() {
  ...
  return /* @__PURE__ */ s("div", { "aria-hidden": "true", className: "main-image--wrapper relative w-full h-125-px md:h-250-px lg:h-350-px overflow-hidden", children: [
    /* @__PURE__ */ t(
      "div",
      {
...
function ce({ searchLabel: e, searchUrl: r }) {
...
function de({ items: e, ariaLabel: r, className: a = "" }) {
  return e.length === 0 ? null : /* @__PURE__ */ t("nav", { "aria-label": r, className: a, children: /* @__PURE__ */ t("ol", { className: "block list-none m-0 p-0", children: e.map((l, n) => /* @__PURE__ */ s("li", { className: "inline", children: [
    n > 0 && /* @__PURE__ */ t("span", { "aria-hidden": "true", className: "mx-2", children: "/" }),
...
export {
  ...
  de as Breadcrumb,
  re as Button,
  se as LanguageSwitcher,
  oe as MainImage,
  S as RichText,
  ce as SearchBlock,
  ne as SearchComponent,
  le as SkipLink,
  ie as ThemeToggle,
  z as sanitizeCmsHtml,
  $ as sanitizeCmsUrl
};
